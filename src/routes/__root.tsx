    ...
    head: () => {
      ...
      return {
        meta: [
          ...
          {
            title:
              "HDPE, MDP & Bathroom Solutions in Satna | ShreeJi Enterprises",
          },
          {
            name: "description",
            content:
          ...
          { name: "author", content: "ShreeJi Enterprises" },
          {
            property: "og:title",
            content:
              "HDPE, MDP & Bathroom Solutions in Satna | ShreeJi Enterprises",
          ...
          {
            property: "og:url",
            content: "https://shreejienterprisessatna.com/",
          },
          {
            property: "og:image",
            content: "https://shreejienterprisessatna.com/og-default.jpg",
          },
