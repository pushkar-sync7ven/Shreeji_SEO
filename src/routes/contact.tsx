...
import { Phone, Mail, MapPin, Send, Star, ExternalLink } from "lucide-react";
        ...
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-10">
          ...
          <div className="grid w-full grid-cols-1 gap-6 md:gap-8 lg:grid-cols-[1fr_1.1fr] lg:gap-10">
            ...
            <div className="min-w-0 w-full space-y-5">
              ...
              >
                <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-saffron/10 text-saffron transition group-hover:bg-saffron group-hover:text-white">
                ...
                <span className="min-w-0 flex-1">
                  ...
                  <span className="mt-0.5 block text-xs text-ink-soft">
                    Share your experience with ShreeJi Enterprises
                  </span>
                </span>
                <ExternalLink className="h-4 w-4 shrink-0 text-ink-soft transition group-hover:text-saffron" />
              </a>
            </div>
